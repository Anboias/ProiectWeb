...
//                     <div className="col-9" style={containerJudete}>
//                         <div className="container shadow-lg p-3 mb-5 bg-white rounded post-summary" >
//                             <div className="list-group">
...
//                                     let imagineCurenta = judet.imagineStema ? 
//                                         images(`./${judet.imagineStema}`) 
//                                         : 
...
//                             <hr />
//                             <form onSubmit={this.adaugaValoare} className="form-row align-items-center">
